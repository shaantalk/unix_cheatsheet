window.onload = function() {
    ...
    data.sections.forEach(containerEl => {
        strContent += '<div class="row justify-content-center align-items-center"><div class="section-title text-center pt-20"><h2 class="title">' + containerEl.title + '</h2></div></div>'
        console.log(containerEl.title)
        count = 0
        containerEl.commands.forEach(command => {

            if (count == 0) {
                strContent += '<div class="row" id="' + (containerEl.title).replace(" ", "") + '">'
            }

            count++;

            // if (count == 3) {
            //     strContent += '</div><div class="row">'
            //     count == 0;
            // }

            strContent += '<div class="col-sm-4 d-flex mt-10 mb-10"><div class="card flex-fill"><div class="card-header">' + command.command + '</div><div class="card-body">' + command.description + '</div></div></div>';
        });
    ...
    this.document.getElementById("allTerms").innerHTML += strContent
